# JAVA REST-клієнт з підтримкою системи «Трембіта»
...
Для демонстрації інтеграції з системою «Трембіта» було розроблено [вебсервіс](https://github.com/Trembita-installation/dev-services-and-clients/Trembita_J_R_SyncSrv) для роботи з даним вебклієнтом.
