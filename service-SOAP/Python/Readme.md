# Синхронний Python SOAP-сервіс з підтримкою системи «Трембіта»
...
Для демонстрації інтеграції з системою «Трембіта» було розроблено [вебклієнт](https://github.com/Trembita-installation/dev-services-and-clients/tree/main/client-SOAP/Python) для роботи з даним вебсервісом.
...
З цією метою було розроблено окремий скрипт, інсталяція та робота з яким описані [тут](https://github.com/Trembita-installation/dev-services-and-clients/Trembita_PutFakeData_SOAP)
